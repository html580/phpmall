...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='行为日志表' AUTO_INCREMENT=37 ;
...
CREATE TABLE IF NOT EXISTS `diygw_banner` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
...
--
-- 转存表中的数据 `diygw_banner`
--

INSERT INTO `diygw_banner` (`id`, `name`, `img`, `status`, `update_time`) VALUES
(1, '小程序图片1', '/static/uploads/picture/20170601/f0fe1532f5d3fdcfb0b8509926bc08c5.jpg', '1', 0),
(2, '小程序图片2', '/static/uploads/picture/20170601/58465aabef8f36f13859c955fcc980d6.jpg', '1', 0),
(3, '小程序图片3', '/static/uploads/picture/20170601/2944bee3664ad01a27bf3dad57f2124f.jpg', '1', 0);
...
CREATE TABLE IF NOT EXISTS `diygw_cart` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
  `total` int(5) DEFAULT '1',
  `link_id` varchar(40) DEFAULT '' COMMENT '钩子名称',
  `link_table` varchar(50) DEFAULT NULL,
  `user_id` varchar(100) DEFAULT NULL COMMENT '描述',
  `price` decimal(15,2) unsigned DEFAULT '1.00' COMMENT '类型',
  `update_time` int(10) unsigned DEFAULT '0' COMMENT '更新时间',
  `status` tinyint(1) unsigned DEFAULT '1',
  PRIMARY KEY (`id`)
...
INSERT INTO `diygw_cart` (`id`, `total`, `link_id`, `link_table`, `user_id`, `price`, `update_time`, `status`) VALUES
(26, 2, '1', 'content', 'diygw_com', '1.00', 0, 1),
(27, 1, '2', 'content', 'diygw_com', '1.00', 0, 1),
(28, 1, '20', 'content', 'diygw_com', '1.00', 0, 1),
(29, 2, '244', 'content', 'diygw_com', '19.00', 0, 1);
...
CREATE TABLE IF NOT EXISTS `diygw_cate` (
...
INSERT INTO `diygw_cate` (`status`, `id`, `name`, `title`, `pid`) VALUES
(1, 1, 'diygw', 'DIY官网', 0),
(1, 2, 'xcx', '微信小程序', 1),
(1, 3, 'page', '单页动画', 1),
(1, 4, 'system', '原型设计', 1);
...
(1, '首页', 0, 1, 'Index/index', 0, '', '', 0, NULL, 1),
...
CREATE TABLE IF NOT EXISTS `diygw_order` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
  `items` text,
  `address_id` varchar(40) DEFAULT '' COMMENT '钩子名称',
  `user_id` varchar(100) DEFAULT NULL COMMENT '描述',
  `total` decimal(15,2) unsigned DEFAULT '1.00' COMMENT '类型',
  `update_time` int(10) unsigned DEFAULT '0' COMMENT '更新时间',
  `status` tinyint(1) unsigned DEFAULT '1',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=35 ;
...
INSERT INTO `diygw_order` (`id`, `items`, `address_id`, `user_id`, `total`, `update_time`, `status`) VALUES
(34, '[{"category_id":43,"id":29,"name":"DiyGw.com助您实现快速原型设计工具","img":"/static/uploads/picture/20170601/b45191503f453c7ae84a5ac21c4bba5b.png","remark":"DiyGw.com助您实现快速原型设计工具","price":"19.00","status":1,"update_time":0,"content":"<p>\\r\\n\\t\\t</p><p>\\r\\n\\t\\t\\t</p><h1>DIY官网助您实现快速原型设计工具</h1><p>\\r\\n\\t\\t\\t</p><p>更快速、更简单、更高效的原型设计工具，适合网页或APP原型的制作</p><p>\\r\\n\\t\\t\\t</p><p>轻松导出基于Bootstrap,Weui高可用原型代码，下载代码后就能转为您系统所有</p><p>\\r\\n\\t\\t</p><p>\\r\\n\\t\\t</p><p>\\r\\n\\t\\t\\t<a class=\\"a-btn1\\" href=\\"http://www.diygw.com/login.html\\">立即定制</a>\\r\\n\\t\\t</p><p>\\r\\n\\t\\t</p><p>\\r\\n\\t\\t\\t<img src=\\"http://lib.diygw.com/themes/design/images/pic7.png\\"/>\\r\\n\\t\\t</p><p>\\t\\t\\t\\r\\n\\t</p><p>\\r\\n\\t</p><p>\\r\\n\\t\\t</p><p>\\r\\n\\t\\t\\t</p><h2>DIY官网将打造智能云数据表单</h2><p>\\r\\n\\t\\t\\t</p><p>无需特殊技能，都可以通过简单拖拽操作的创建出符合业务需求的表单</p><p>\\r\\n\\t\\t\\t</p><p>如问卷调查、客户登记、意见反馈、活动报名、在线订单等。</p><p>\\r\\n\\t\\t</p><p>\\r\\n\\t\\t</p><p>\\r\\n\\t\\t\\t<img src=\\"http://lib.diygw.com/themes/design/images/pic9.png\\" title=\\"DIY官网将打造智能云数据表单,通过简单拖拽操作的创建出符合业务需求的表单\\"/>\\r\\n\\t\\t</p><p>\\t\\t\\r\\n\\t</p><p>\\r\\n\\t</p><p>\\r\\n\\t\\t</p><p>\\r\\n\\t\\t\\t</p><h2>DIY官网将打造一站式云管理系统平台</h2><p>\\r\\n\\t\\t\\t</p><p>随时随地移动办公,让你的企业协作更高效</p><p>\\r\\n\\t\\t\\t</p><p>如会议签到系统，投票系统，办公自动化OA系统，客户关系管理CRM系统，简单的进销存等。</p><p>\\r\\n\\t\\t</p><p>\\t\\r\\n\\t\\t</p><p>\\r\\n\\t\\t\\t<img src=\\"http://lib.diygw.com/themes/design/images/pic10.png\\" title=\\"打造一站式云管理系统平台,随时随地移动办公,让你的企业协作更高效\\"/>\\r\\n\\t\\t</p><p>\\t\\t\\r\\n\\t</p><p><br/></p>","pid":0,"model_id":25,"total":2,"link_id":"244","link_table":"content","user_id":"diygw_com","path":"http://xcx.diygw.com/static/uploads/picture/20170601/b45191503f453c7ae84a5ac21c4bba5b.png","totalAmount":38}]', '30', 'diygw_com', '1.00', 0, 1),
(31, '[{"cat_id":2,"id":26,"name":"fsdf","img":"http://static.html580.com/upload/image/2017/02/form1.png","remark":"DIY官网打造的商品详情，点击加入购物车测试哟","price":"1.00","update_time":0,"addons":"","status":1,"total":2,"link_id":"1","link_table":"content","user_id":"diygw_com","path":"http://static.html580.com/upload/image/2017/02/form1.png","totalAmount":2},{"cat_id":2,"id":27,"name":"fff","img":"http://static.html580.com/upload/image/2017/02/form2.png","remark":"DIY官网打造的商品详情，点击加入购物车测试哟","price":"1.00","update_time":0,"addons":"returntop","status":1,"total":1,"link_id":"2","link_table":"content","user_id":"diygw_com","path":"http://static.html580.com/upload/image/2017/02/form2.png","totalAmount":1},{"cat_id":2,"id":28,"name":"ss","img":"http://static.html580.com/upload/image/2017/02/form3.png","remark":"DIY官网打造的商品详情，点击加入购物车测试哟","price":"1.00","update_time":0,"addons":"","status":1,"total":1,"link_id":"20","link_table":"content","user_id":"diygw_com","path":"http://static.html580.com/upload/image/2017/02/form3.png","totalAmount":1}]', '30', 'diygw_com', '1.00', 0, 1),
(32, '[{"cat_id":2,"id":26,"name":"fsdf","img":"http://static.html580.com/upload/image/2017/02/form1.png","remark":"DIY官网打造的商品详情，点击加入购物车测试哟","price":"1.00","update_time":0,"addons":"","status":1,"total":2,"link_id":"1","link_table":"content","user_id":"diygw_com","path":"http://static.html580.com/upload/image/2017/02/form1.png","totalAmount":2},{"cat_id":2,"id":27,"name":"fff","img":"http://static.html580.com/upload/image/2017/02/form2.png","remark":"DIY官网打造的商品详情，点击加入购物车测试哟","price":"1.00","update_time":0,"addons":"returntop","status":1,"total":1,"link_id":"2","link_table":"content","user_id":"diygw_com","path":"http://static.html580.com/upload/image/2017/02/form2.png","totalAmount":1},{"cat_id":2,"id":28,"name":"ss","img":"http://static.html580.com/upload/image/2017/02/form3.png","remark":"DIY官网打造的商品详情，点击加入购物车测试哟","price":"1.00","update_time":0,"addons":"","status":1,"total":1,"link_id":"20","link_table":"content","user_id":"diygw_com","path":"http://static.html580.com/upload/image/2017/02/form3.png","totalAmount":1}]', '30', 'diygw_com', '1.00', 0, 1),
(33, '[{"cat_id":2,"id":26,"name":"fsdf","img":"http://static.html580.com/upload/image/2017/02/form1.png","remark":"DIY官网打造的商品详情，点击加入购物车测试哟","price":"1.00","update_time":0,"addons":"","status":1,"total":2,"link_id":"1","link_table":"content","user_id":"diygw_com","path":"http://static.html580.com/upload/image/2017/02/form1.png","totalAmount":2},{"cat_id":2,"id":27,"name":"fff","img":"http://static.html580.com/upload/image/2017/02/form2.png","remark":"DIY官网打造的商品详情，点击加入购物车测试哟","price":"1.00","update_time":0,"addons":"returntop","status":1,"total":1,"link_id":"2","link_table":"content","user_id":"diygw_com","path":"http://static.html580.com/upload/image/2017/02/form2.png","totalAmount":1},{"cat_id":2,"id":28,"name":"ss","img":"http://static.html580.com/upload/image/2017/02/form3.png","remark":"DIY官网打造的商品详情，点击加入购物车测试哟","price":"1.00","update_time":0,"addons":"","status":1,"total":1,"link_id":"20","link_table":"content","user_id":"diygw_com","path":"http://static.html580.com/upload/image/2017/02/form3.png","totalAmount":1}]', '30', 'diygw_com', '1.00', 0, 1);
